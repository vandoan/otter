class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.for(:account_update) { |u| u.permit(:username, :hobbies, :email, :password, :password_confirmation, :profile_name, :favorite_books, :current_password) }
  end
